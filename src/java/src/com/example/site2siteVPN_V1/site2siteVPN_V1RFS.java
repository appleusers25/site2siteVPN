package com.example.site2siteVPN_V1;

import com.example.site2siteVPN_V1.namespaces.*;
...
public class site2siteVPN_V1RFS {
    ...
    @ServiceCallback(servicePoint="site2siteVPN_V1-servicepoint",
    ...
    public Properties create(ServiceContext context,
        ...
        Template myTemplate = new Template(context, "site2siteVPN_V1-template");
     ...
     */
    @ActionCallback(callPoint="site2siteVPN_V1-self-test", callType=ActionCBType.INIT)
     ...
     */
    @ActionCallback(callPoint="site2siteVPN_V1-self-test", callType=ActionCBType.ACTION)
    public ConfXMLParam[] selftest(DpActionTrans trans, ConfTag name,
                                   ConfObject[] kp, ConfXMLParam[] params)
    throws DpCallbackException {
        try {
            // Refer to the service yang model prefix
            String nsPrefix = "site2siteVPN_V1";
